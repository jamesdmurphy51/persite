...
$(document).on("ready", function() {
	...
	// Set body background
	$("body").css({"background":$(".lx-wrapper").attr("data-background-color")+" url('"+$(".lx-wrapper").attr("data-background")+"') no-repeat"});
	...
	window.setInterval(function(){
		var lx_date = new Date();
		var hours = lx_date.getHours().toString().length==1 ? "0" + lx_date.getHours().toString() : lx_date.getHours().toString();
		var mins = lx_date.getMinutes().toString().length==1 ? "0" + lx_date.getMinutes().toString() : lx_date.getMinutes().toString();
		var secs = lx_date.getSeconds().toString().length==1 ? "0" + lx_date.getSeconds().toString() : lx_date.getSeconds().toString();  
		$(".lx-time").text(hours + ":" + mins + ":" + secs);
	},1000);
